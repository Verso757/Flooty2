  ...
  return (
    <div className="min-h-[80vh] flex flex-col justify-center max-w-lg mx-auto p-4 animate-fade-in">
      ...
      <Modal
        ...
        subtitle="Ingresa el PIN de Administrador para liberar la unidad bajo responsabilidad del supervisor."
        size="sm"
      >
        <form onSubmit={handleAdminOverride} className="space-y-3">
          <div className="w-10 h-10 bg-slate-100 text-slate-800 rounded-xl flex items-center justify-center mx-auto border border-slate-200">
